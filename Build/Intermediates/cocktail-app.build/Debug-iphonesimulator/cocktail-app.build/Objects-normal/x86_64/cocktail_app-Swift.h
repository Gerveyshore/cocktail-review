...
#ifndef COCKTAIL_APP_SWIFT_H
#define COCKTAIL_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="cocktail_app",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12cocktail_app11AppDelegate")
...
SWIFT_CLASS("_TtC12cocktail_app13SceneDelegate")
...
@interface ViewController (SWIFT_EXTENSION(cocktail_app)) <UITableViewDelegate>
